...
{
    public static int Vocabulary_Num = 20;
    ...
    public static string[] Vocabulary_C_Name = new string[20] {  "進入", "羞恥的", "有關當局", "無遮蓋的", "行為", "公民", "不協調","破壞","使筋疲力盡","堡壘","優美的","侵略","神秘","佔；住", "限制", "安全","投擲","軍隊", "改變", "邪惡的" };
    public static string[] Vocabulary_Voice = new string[20] { "access", "ashamed", "authority", "bare", "behavior", "citizen", "clash", "dictionary", "exhaust", "fort", "graceful", "invade", "mystery", "occupy", "restrict", "security", "toss", "troop", "vary", "wicked" };
    public static string[] Vocabulary_PartOfSpeech = new string[20] { "n.名詞", "adj.形容詞", "n.名詞", "adj.形容詞", "n.名詞","n.名詞", "n.名詞；v.i.動詞", "n.名詞", "v.t.動詞" , "n.名詞", "adj.形容詞", "v.t.動詞", "n.名詞", "v.t.動詞", "v.t.動詞", "n.名詞", "v.t.動詞", "n.名詞", "v.t.動詞", "adj.形容詞" };
    public static string[] Vocabulary_Sentence = new string[20] {
